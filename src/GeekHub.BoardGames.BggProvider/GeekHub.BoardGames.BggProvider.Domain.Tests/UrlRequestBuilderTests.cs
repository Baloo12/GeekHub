namespace GeekHub.BoardGames.BggProvider.Domain.Tests
{
    ...
    public class UrlRequestBuilderTests
    {
        ...
        public class Constructor : UrlRequestBuilderTests
        {
            [Theory]
            [ClassData(typeof(EmptyStringsData))]
            public void EmptyBaseUrl_ThrowEmptyBaseUrlException(string emptyUrl)
            {
                Assert.Throws<EmptyBaseUrlException>(() => new UrlRequestBuilder(emptyUrl, null, _parameterConstructorMock.Object));
            }

            [Fact]
            public void ParameterItemTypeIsEmpty_ThrowEmptyParametersItemTypeException()
            {
            ...
            [Fact]
            public void ParametersIsNull_ThrowEmptyRequestParametersException()
            {
                Assert.Throws<EmptyRequestParametersException>(() => new UrlRequestBuilder(ExampleBaseUrl, null, _parameterConstructorMock.Object));
            }
        }

        public class Build : UrlRequestBuilderTests
        {
            [Fact]
            public void EmptyParameters_ReturnBaseUrlWithItemType()
            {
            ...
            [Fact]
            public void ManyParameters_ReturnCorrectUrl()
            {
            ...
            [Fact]
            public void OneParameter_ReturnCorrectUrl()
            {
